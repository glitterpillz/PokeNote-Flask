...
class Pokemon(db.Model):
    __tablename__= add_prefix_for_prod('pokemons')
    ...
    can_fly = db.Column(db.Boolean, nullable=True, server_default='false')
    is_floating = db.Column(db.Boolean, nullable=True, server_default='false')
